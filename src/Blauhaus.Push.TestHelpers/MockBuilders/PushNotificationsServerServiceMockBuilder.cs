...
namespace Blauhaus.Push.TestHelpers.MockBuilders
{
    public class PushNotificationsServerServiceMockBuilder : BaseMockBuilder<PushNotificationsServerServiceMockBuilder, IPushNotificationsServerService>
    {
        ...
        {
            Mock.Setup(x => x.UpdateDeviceRegistrationAsync(Any<IDeviceRegistration>(), Any<IPushNotificationsHub>(), AnyToken))
        ...
        {
            Mock.Setup(x => x.LoadRegistrationForUserDeviceAsync(AnyString, AnyString, Any<IPushNotificationsHub>(), AnyToken))
                .ReturnsAsync(Response.Success(result));
            return this;
        }
        ...
        {
            Mock.Setup(x => x.DeregisterUserDeviceAsync(AnyString, AnyString, Any<IPushNotificationsHub>(), AnyToken))
                .ReturnsAsync(result);
            return this;
        }
